...
latex_documents = [
    (master_doc, "helanal.tex", "helanal Documentation",
     "helanal", "manual"),
]
...
man_pages = [
    (master_doc, "helanal", "helanal Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "helanal", "helanal Documentation",
     author, "helanal", "A package to characterise the geometry of protein helicies.",
     "Miscellaneous"),
]
